                    ...
                    <div class="card-header border-bottom">
                        <form class="input-group col-md-6 col-lg-4 ml-auto" @submit.prevent="createExpenditure"
                            ...
                            <input type="text" v-model="form.name" class="form-control border"
                                   placeholder="Add New Payment System"
                                   aria-label="Add New Payment System" name="name">
...
<script>
    import expenditure from './PaymentEdit';
    export default {
        data() {
            return {
                expenditures: {},
        ...
        methods: {
            loadExpenditure() {
                axios.get('api/payment').then(({data}) => (this.expenditures = data));
            },
            getResults(page = 1) {
